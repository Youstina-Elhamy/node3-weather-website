...
const app = express()
const port = process.env.PORT ||3000 //is there is no port use 3000
...
app.listen(port, () => {
    console.log('The server is up on port ' +port + ' .') // this is gonna disply in the terminal not in the browser as a usefull peace of information when running the application 
})
